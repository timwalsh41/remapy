# https://github.com/rougier/freetype-py/blob/04c62af91c66b3268051921d609c9552d93560aa/examples/glyph-vector-2.py
...
if __name__ == '__main__':
    ...
    face = Face('znikoslsvginot-font/Znikoslsvginot8-GOB3y.ttf')
